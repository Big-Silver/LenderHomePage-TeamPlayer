...
<script>
import { fetchList, createTeam, updateTeam, deleteTeam } from '@/api/team';
  ...
  methods: {
    ...
    handleDownload() {
      ...
      import('@/vendor/Export2Excel').then(excel => {
        const tHeader = ['timestamp', 'name'];
        const filterVal = ['timestamp', 'name'];
